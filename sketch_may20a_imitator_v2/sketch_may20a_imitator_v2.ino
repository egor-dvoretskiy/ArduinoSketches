/////************* Imitator v.2 (Разные серийники, один дрон, разные координаты)*****////////
/////////////////////////////////////////////////////////////////////////////////////////////
...
void loop() {        
    ...
    for (int i = 216, j = 0; i <= 219; i++, j++)
    {
       wifipkt[i] = traceLongitude[j+4*mc];
    }
    for (int i = 220, j = 0; i <= 223; i++, j++)
    {
       wifipkt[i] = traceLatitude[j+4*mc];
    }    
