/////************* Imitator v.1 (Один серийник, один дрон, схожие координаты)*****//////
/////////////////////////////////////////////////////////////////////////////////////////////
...
byte wifipkt[] = {
    ...
    0x8e, 0xd1, 0x49, 0x00, //27                                 //RawLon i = (216:219)
    0x24, 0xb7, 0x8f, 0x00, //54                                 //RawLat  i = (220:223)
    ...
    0xf4, 0x00,                                                  //Roll
    0x40, 0x00,                                                  //Yaw                                                                                                     
    0x8e, 0xd1, 0x49, 0x00,  //39.971056                         //RawHomeLon                                                                                                    
    0x24, 0xb7, 0x8f, 0x00,  //56.004938                         //RawHomeLat
    0x06,                                                        //ProductType i = 248
    0x06,                                                        //UUID length
...
byte productType[] = {  0x0b,     //Phantom 4 Adv.
                        0x0c,     //MG1
                        0x29,     //Mavic 2
                        0x1c,     //M210
                        0x0f,     //Phantom 3 4k
...
void loop() { 
      wifi_send_pkt_freedom(wifipkt, 269, true);
      delay(33);
}
